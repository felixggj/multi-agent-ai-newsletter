...
This command initializes the ai-football-newsletter Crew, assembling the agents and assigning them tasks as defined in your configuration.
...
For support, questions, or feedback regarding the AiFootballNewsletter Crew or crewAI.
